...
load_dotenv()  # pulls FFMPEG_PATH / OLLAMA_MODEL / WHISPER_MODEL / VOSK_MODEL_PATH etc. from .env
...
# Allow the React dev dashboard (Vite, default port 5173) and any local
# frontend to call this API directly. Tighten allow_origins before any
# real deployment.
app.add_middleware(
    CORSMiddleware,
    allow_origins=[
